      ...
      <div className="Section-space-top Section-space-bottom">
        ...
        <Slider slidesToScroll={3} slidesToShow={3}>
          <CardApproved
            ...
            info={
              <>
                Vextabit has been listed by <a href="https://bitcoin.org/en/wallets/mobile/ios/unstoppable/" target="_blank"
          ...
          <CardApproved
            ...
            info={
              <>
                Vextabit was audited by <a href="https://www.certik.org/projects/unstoppable.money" target="_blank" rel="noopener noreferrer"
          ...
          <CardApproved
            ...
            info={
              <>
                ...
                code they claim to. Vextabit is verifiably open source wallet.
              </>
            } />
        </Slider>
      </div>
