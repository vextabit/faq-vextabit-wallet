# Which DEXes supported in Vextabit?

Vextabit wallet currently supports following decentralized exchanges:
...
In the near future, Vextabit aims to complete integration with Thorchain (https://thorchain.org) decentralized exchange that enables cryptocurrency trades between blockchains for the first time.
