# Which DEXes are supported in Vextabit?

Vextabit wallet currently supports the following decentralized exchanges:
...
In the future, Vextabit aims to complete integration with the [Thorchain](https://thorchain.org) decentralized exchange that enables cryptocurrency trades between blockchains.
